package com.calendarapp.widget;
...
import com.calendarapp.CalendarUtils;
import com.calendarapp.R;
import com.calendarapp.ViewUtils;
import com.calendarapp.weather.Weather;
...
public class AgendaView extends RecyclerView {
    ...
    private OnScrollAgendaView mScrolllistener;
    ...
    public interface OnScrollAgendaView {

        void onScrollAgenda(int firstVisibleItem, int visibleItemCount);
    }
    ...
    public void onScrolled(int dx, int dy) {
        if (dy != 0) { // avoid loading more or triggering notification on 1st layout
            ...
            int firstVisibleItem=getLinearLayoutManager().findFirstVisibleItemPosition();
                    int visibleItemCount=getLinearLayoutManager().getChildCount();
            mScrolllistener.onScrollAgenda( firstVisibleItem,  visibleItemCount);
    ...
    public void setOnscrollListener(OnScrollAgendaView listener) {
